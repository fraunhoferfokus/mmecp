...
public class RovClient {
    ...
    // private final String serviceBaseUrl = "http://127.0.0.1/api/rovsim/action/runsim";
    private final static String ServiceBaseUrl = "http://localhost:8080/api-rest/";
    ...
    public RovClient() throws GeneralSecurityException {
        this.init();
    }
    ...
    public void init(boolean trustAllCertificates) throws GeneralSecurityException {
        ...
        this.target = resteasyClient.target(ServiceBaseUrl);
    }
